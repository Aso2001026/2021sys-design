...
会員情報 -left-> ログイン : ログインをクリック
会員情報 --> カート内 :カートをクリック
会員情報 -> 各SNS :SNSのアイコンをクリック
会員情報 -> お問い合わせ : お問い合わせをクリック


商品詳細 --> カート内 : カートをクリック
商品詳細 --> トップページ : 前の画面に戻るをクリック
商品詳細 -left-> ログイン : ログインをクリック
商品詳細 -> 各SNS :SNSのアイコンをクリック
商品詳細 -> お問い合わせ : お問い合わせをクリック
商品詳細 -up-> 会員情報 : 会員情報をクリック
商品詳細:do/商品説明を表示
...
カート内 -> 各SNS :SNSのアイコンをクリック
カート内 -> お問い合わせ : お問い合わせをクリック
カート内 -> 商品詳細 : 詳細へをクリック
カート内 -up-> 会員情報 : 会員情報をクリック

state ログイン{
[*]->ログインページ
ログインページ -> 会員登録 : 会員登録はこちらをクリック
 state 会員登録{
   [*] ->会員情報登録
